...
public class Contructor_Hotel_Problem {
	...
	public Contructor_Hotel_Problem(String code){
		if(code.equals("ZRE234")) {
			int total,no_day=10,no_food=20,per_day=200,per_food=100,cgst,sgst;
			int amount = no_day * per_day;
			int food = no_food * per_food;
			total = amount + food;
			System.out.println("The Total charge for staying is : "+ total);
			cgst = total * 18 / 100 ;
			sgst = total * 18 / 100 ;
  ...
  public static void main(String[] args) {
	...
	Contructor_Hotel_Problem sguy = new Contructor_Hotel_Problem("ZRE234");
} 
}
